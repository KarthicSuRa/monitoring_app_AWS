                ...
                <header className="bg-white/80 backdrop-blur-sm fixed top-0 left-0 right-0">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between h-24">
                            ...
                            <div className="flex items-center space-x-3">
                                <Link to="/login" className="text-blue-600 hover:text-blue-700 transition-colors font-semibold px-5 py-2.5 rounded-lg text-sm border border-gray-300 hover:border-blue-600">
                                    Log In
                                </Link>
                            </div>
                        </div>
                ...
                <main className="pt-24">
                    ...
                    <section className="px-4 pt-20 pb-28 text-center bg-gray-50/80 backdrop-blur-sm">
                        <div className="container mx-auto">
                            ...
                            <Link to="/login" className="bg-blue-600 text-white font-bold px-8 py-4 rounded-lg text-lg hover:bg-blue-700 transition-colors">
                                Get Started
                            </Link>
                        </div>
                    </section>
