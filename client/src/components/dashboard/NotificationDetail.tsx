...
import { Notification, NotificationStatus, Comment, NotificationUpdatePayload, User } from '../../types';
...
export const NotificationDetail: React.FC<NotificationDetailProps> = ({ notification, onUpdateNotification, onAddComment, user, userNames }) => {
