...
const paymentMethods = [
    { name: 'Credit Card', provider: 'Adyen', volume: '55.2%', success: 97.2, icon: 'credit-card' },
    { name: 'Apple Pay', provider: 'Adyen', volume: '10.5%', success: 99.8, icon: 'apple' },
    { name: 'Klarna Pay Later', provider: 'Adyen', volume: '9.1%', success: 98.5, icon: 'klarna' },
    { name: 'Klarna Monthly Financing', provider: 'Adyen', volume: '6.1%', success: 97.5, icon: 'klarna' },
    { name: 'Klarna Pay Now', provider: 'Adyen', volume: '4.1%', success: 96.5, icon: 'klarna' },
    { name: 'PayPal', provider: 'PayPal', volume: '15.0%', success: 99.1, icon: 'paypal' },
];

const transactions = [
    { time: '12:21:20', amount: '€150.00', provider: 'Credit Card', status: 'failed', reason: 'do_not_honor', orderId: 'a1b2c-3456' },
    { time: '12:21:18', amount: '€75.50', provider: 'PayPal', status: 'succeeded', reason: '', orderId: 'd4e5f-6789' },
    { time: '12:21:15', amount: '€250.00', provider: 'Apple Pay', status: 'succeeded', reason: '', orderId: 'g7h8i-9012' },
    { time: '12:21:12', amount: '€45.00', provider: 'Klarna Pay Later', status: 'succeeded', reason: '', orderId: 'j1k2l-3456' },
    { time: '12:21:09', amount: '€125.00', provider: 'Credit Card', status: 'succeeded', reason: '', orderId: 'm3n4o-5678' },
];

const germanyDeclineData = [
...
const GermanyDeepDive: React.FC = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    <DeclineCodes data={germanyDeclineData} />
                </div>
            </div>
            <div>
...
export default GermanyDeepDive;
