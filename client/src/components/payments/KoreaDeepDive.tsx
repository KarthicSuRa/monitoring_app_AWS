...
const paymentMethods = [
    { name: 'Toss – Credit Card', provider: 'Toss', volume: '60.2%', success: 98.2, icon: 'credit-card' },
    { name: 'Toss – Bank Transfer', provider: 'Toss', volume: '20.5%', success: 99.8, icon: 'university' },
    { name: 'Toss – EasyPay', provider: 'Toss', volume: '19.3%', success: 97.5, icon: 'toss' },
];

const transactions = [
    { time: '12:21:20', amount: '₩150,000', provider: 'Toss – Credit Card', status: 'failed', reason: 'do_not_honor', orderId: 'a1b2c-3456' },
    { time: '12:21:18', amount: '₩75,500', provider: 'Toss – EasyPay', status: 'succeeded', reason: '', orderId: 'd4e5f-6789' },
    { time: '12:21:15', amount: '₩250,000', provider: 'Toss – Bank Transfer', status: 'succeeded', reason: '', orderId: 'g7h8i-9012' },
    { time: '12:21:12', amount: '₩45,000', provider: 'Toss – Credit Card', status: 'succeeded', reason: '', orderId: 'j1k2l-3456' },
    { time: '12:21:09', amount: '₩125,000', provider: 'Toss – Credit Card', status: 'succeeded', reason: '', orderId: 'm3n4o-5678' },
];

const koreaDeclineData = [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    <DeclineCodes data={koreaDeclineData} />
                </div>
            </div>
            <div>
