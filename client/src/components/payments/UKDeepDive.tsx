...
const paymentMethods = [
    { name: 'Credit Card', provider: 'Adyen', volume: '65.2%', success: 98.2, icon: 'credit-card' },
    { name: 'Apple Pay', provider: 'Adyen', volume: '12.5%', success: 99.5, icon: 'apple' },
    { name: 'Klarna Pay Later', provider: 'Adyen', volume: '8.1%', success: 97.5, icon: 'klarna' },
    { name: 'Klarna Monthly Financing', provider: 'Adyen', volume: '5.1%', success: 96.5, icon: 'klarna' },
    { name: 'PayPal', provider: 'PayPal / Adyen', volume: '9.1%', success: 99.2, icon: 'paypal' },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    <DeclineCodes data={ukDeclineData} />
                </div>
            </div>
            <div>
