...
const paymentMethods = [
    { name: 'Credit Card', provider: 'Adyen', volume: '50.2%', success: 98.2, icon: 'credit-card' },
    { name: 'Apple Pay', provider: 'Adyen', volume: '15.5%', success: 99.8, icon: 'apple' },
    { name: 'Alipay', provider: 'Adyen', volume: '10.1%', success: 97.5, icon: 'alipay' },
    { name: 'GrabPay', provider: 'Adyen', volume: '8.1%', success: 96.5, icon: 'grab' },
    { name: 'Atome', provider: 'Atome', volume: '5.1%', success: 95.5, icon: 'atome' },
    { name: 'PayPal', provider: 'PayPal', volume: '11.0%', success: 99.1, icon: 'paypal' },
];

const transactions = [
    { time: '12:21:20', amount: 'S$150.00', provider: 'Credit Card', status: 'failed', reason: 'do_not_honor', orderId: 'a1b2c-3456' },
    { time: '12:21:18', amount: 'S$75.50', provider: 'PayPal', status: 'succeeded', reason: '', orderId: 'd4e5f-6789' },
    { time: '12:21:15', amount: 'S$250.00', provider: 'Apple Pay', status: 'succeeded', reason: '', orderId: 'g7h8i-9012' },
    { time: '12:21:12', amount: 'S$45.00', provider: 'Alipay', status: 'succeeded', reason: '', orderId: 'j1k2l-3456' },
    { time: '12:21:09', amount: 'S$125.00', provider: 'Credit Card', status: 'succeeded', reason: '', orderId: 'm3n4o-5678' },
];

const singaporeDeclineData = [
...
const SingaporeDeepDive: React.FC = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    <DeclineCodes data={singaporeDeclineData} />
                </div>
            </div>
            <div>
...
export default SingaporeDeepDive;
