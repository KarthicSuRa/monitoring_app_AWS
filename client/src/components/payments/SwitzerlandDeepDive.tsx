...
const declineCodeColors: { [key: string]: string } = {
    "Do Not Honor": "#ef4444",
...
const paymentMethods = [
    { name: 'Credit Card', provider: 'Adyen', volume: '60.2%', success: 98.2, icon: 'credit-card' },
    { name: 'Apple Pay', provider: 'Adyen', volume: '11.5%', success: 99.8, icon: 'apple' },
    { name: 'Klarna Pay Later', provider: 'Adyen', volume: '7.1%', success: 97.5, icon: 'klarna' },
    { name: 'Klarna Monthly Financing', provider: 'Adyen', volume: '4.1%', success: 96.5, icon: 'klarna' },
    { name: 'Klarna Pay Now', provider: 'Adyen', volume: '3.1%', success: 95.5, icon: 'klarna' },
    { name: 'PayPal', provider: 'PayPal', volume: '12.0%', success: 99.1, icon: 'paypal' },
    { name: 'TWINT', provider: 'TWINT', volume: '2.0%', success: 99.9, icon: 'twint' },
];

const transactions = [
    { time: '12:21:20', amount: 'CHF150.00', provider: 'Credit Card', status: 'failed', reason: 'do_not_honor', orderId: 'a1b2c-3456' },
    { time: '12:21:18', amount: 'CHF75.50', provider: 'PayPal', status: 'succeeded', reason: '', orderId: 'd4e5f-6789' },
    { time: '12:21:15', amount: 'CHF250.00', provider: 'Apple Pay', status: 'succeeded', reason: '', orderId: 'g7h8i-9012' },
    { time: '12:21:12', amount: 'CHF45.00', provider: 'Klarna Pay Later', status: 'succeeded', reason: '', orderId: 'j1k2l-3456' },
    { time: '12:21:09', amount: 'CHF125.00', provider: 'Credit Card', status: 'succeeded', reason: '', orderId: 'm3n4o-5678' },
];

const switzerlandDeclineData = [
...
const SwitzerlandDeepDive: React.FC = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    <DeclineCodes data={switzerlandDeclineData} />
                </div>
            </div>
            <div>
...
export default SwitzerlandDeepDive;
