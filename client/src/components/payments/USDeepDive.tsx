...
const paymentMethods = [
    { name: 'Credit Card', provider: 'Adyen', volume: '75.2%', success: 97.2, icon: 'credit-card' },
    { name: 'Apple Pay', provider: 'Adyen', volume: '6.5%', success: 99.8, icon: 'apple' },
    { name: 'Klarna', provider: 'Adyen', volume: '5.1%', success: 98.5, icon: 'klarna' },
    { name: 'PayPal', provider: 'Adyen', volume: '15.8%', success: 99.1, icon: 'paypal' },
    { name: 'Amazon Pay', provider: 'Amazon Pay', volume: '8.2%', success: 99.5, icon: 'amazon' },
    { name: 'Affirm', provider: 'Affirm', volume: '4.2%', success: 97.9, icon: 'affirm' },
];
...
const transactions = [
    ...
    { time: '12:21:12', amount: '$45.00', provider: 'Klarna', status: 'succeeded', reason: '', orderId: 'j1k2l-3456' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    <DeclineCodes data={usDeclineData} />
                </div>
            </div>
            <div>
